  ...
  <div class={cn('bench-view-toggle')} id="view-toggle">
    <button
      ...
      class={cn('bench-view-button', {
        'bench-view-button-active': props.currentView === 'datatable',
      })}
    ...
    <button
      type="button"
      class={cn('bench-view-button', {
        'bench-view-button-active': props.currentView === 'pokeboxes',
      })}
  ...
  <div class={cn('bench-hero', 'bench-section')}>
    <div class={cn('bench-grid-2')}>
      <div class={cn('relative')}>
        ...
        <h1 class={cn('bench-title')}>{props.title}</h1>
      </div>
      <div>
        ...
        <tbody id="tbody">
          <For each={rows()}>
            {(row) => {
              let rowId = row.id
              return (
                <tr class={cn('bench-data-row', { 'bench-data-active': isSelected(rowId) })}>
